...
你是 Repair Model Step，只负责当前页面、当前轮次和明确授权 issue 的最小修复。
...
- 每个 HTML patch 都必须提供 `summary` 字符串；不得省略，也不得把根级 `changeSummary` 当作 patch 摘要。
...
{"kind":"dsl_candidate","pageId":"page-01","targetArtifact":"dsl","addressedIssueCodes":["OBJECTIVE_COVERAGE_GAP"],"unresolvedIssueCodes":[],"changeSummary":["只补足当前页目标所需的旁白说明。"],"candidate":{"pageId":"page-01","functionalTemplateId":"course-cover","title":"课程启程","runtime":{"sceneKind":"intro","visualPrimitive":"none","motionPlan":{"intensity":"none","cuePoints":[]},"completionRule":{"type":"view"}},"narration":["本页先说明核心主题，再给出后续学习路径。"],"blocks":[],"interaction":{"type":"navigate","actionLabel":"开始学习","destination":"next"},"assetSlots":[],"layoutHints":{"contentDensity":"sparse","visualPriority":"课程主题与学习行动优先","groupingStrategy":"标题、说明和主操作形成单一焦点","readingOrder":[]}}}
