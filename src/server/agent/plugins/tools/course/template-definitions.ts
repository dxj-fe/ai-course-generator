...
export const searchFunctionalTemplateTool: ExecutableTool<
...
export const searchStyleTemplateTool: ExecutableTool<
...
export const validateCourseIntentTool: ExecutableTool<
