...
export const toolDefinitions = Object.freeze([
  ...
  tool(ToolIds.ReadPageWorkspace, "读取当前页面可写工作区。", "read"),
  tool(ToolIds.EditPageWorkspace, "直接创建或修改页面文件。", "write"),
  tool(ToolIds.GeneratePageImage, "按需生成一张页面图片素材。", "write"),
  tool(ToolIds.RenderPage, "在真实浏览器中渲染页面并采集证据。", "compute"),
