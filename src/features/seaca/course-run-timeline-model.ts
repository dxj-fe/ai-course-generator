...
function buildGlobalStages(run: SeacaCourseRun, nowMs: number) {
...
function buildPages(run: SeacaCourseRun, nowMs: number) {
...
function taskDuration(run: SeacaCourseRun, nowMs: number) {
  const generation = run.generation;
...
function taskWasResumed(run: SeacaCourseRun) {
