...
- Days 24–31: future Specialist Prompt tightening, isolated Page Worker, automatic QA/Repair, and optional LangGraph work must continue to project typed public state through the existing controller; the frontend must never consume framework-native chunks directly.
