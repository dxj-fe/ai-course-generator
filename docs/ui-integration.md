...
- Days 26–31: future QA refinement, bounded Repair, and optional LangGraph work must continue to project typed public state through the existing controller; the frontend must never consume framework-native chunks directly.
